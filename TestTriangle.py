...
class TestTriangles(unittest.TestCase):
    ...
    def test_isosceles_triangleA(self):
        self.assertEqual(check_triangle(2, 3, 2), ('Isosceles triangle'))
    def test_isosceles_triangleB(self):
        self.assertEqual(check_triangle(3, 3, 3), ('Equilateral triangle'))
    def test_isosceles_triangleC(self):
        self.assertEqual(check_triangle(201, 3, 6), ('invalid triangle'))
